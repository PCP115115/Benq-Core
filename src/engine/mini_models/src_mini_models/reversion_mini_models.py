...
def train_reversion_model(ticker: str, save_dir: str):
    """
    Entrena DOS modelos complementarios:
    1. 'yz_breakout_up': Probabilidad de tocar Techo sin tocar Suelo.
    2. 'yz_breakout_down': Probabilidad de tocar Suelo sin tocar Techo.
    """
    
    # --- 1. CARGA Y PREPARACIÓN ---
    horizon = config.MINI_MODEL_PARAMS["FORECAST_HORIZON"]
    z_score = config.FEATURES_PARAMS["YZ_Z_SCORE"]
    features_trend = config.MINI_MODEL_PARAMS["FEATURES_REVERSION"]
